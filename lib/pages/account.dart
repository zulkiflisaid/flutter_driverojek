...
class Accounts extends StatefulWidget {
  ...
  Accounts({Key key, this.data_p}) : super(key: key);
...
class _AccountsState extends State<Accounts> {
  ...
  static const platform_keluar = const MethodChannel('channel.keluar'); 
 ...
 Future<Map> _channelLogout() async {
    try {
   var result_keluar=   await platform_keluar.invokeMethod('Logout');
      //setData(sharedData  );
      debugPrint('Result: $result_keluar ');
          ...
          itemBuilder: (context, index) { 
            ...
            if(index==0){ 
                    ...
                    child:ListTile( 
                      ...
                      title: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text('${widget.data_p['name']}',     ), 
                           Text('${widget.data_p['email']}'  ), 
                           Text('${widget.data_p['hp']}'),
                        ],
                      ), 
                    // trailing: Icon(
                    //   Icons.mode_edit,
                    ...
                    child:  Padding(
                      ...
                      child:  Container(
                        decoration: BoxDecoration(
                            color:  widget.data_p['aktivasi'] == '1'  ?  Colors.green  : Color(0xfff43f24),
                            border: Border.all(
                         ...
                         children: [  
                            Padding(
                              padding: const EdgeInsets.only(left: 5),
                                child: Container(
                                    child:  widget.data_p['aktivasi'] == '1'  ? 
                              ...
                              padding: const EdgeInsets.only(right:  5),
                                child: Container(
                                    ...
                                    color: Colors.white ,
                                    child:  widget.data_p['aktivasi'] == '1'  ?  Text( 'Ubah')  : Text( 'Verifikasi') ,
                                    onPressed: () {   
              ...
              onPressed: () {
                if(index==2){
                  //kode promo
                  Navigator.push( context,MaterialPageRoute(builder: (context) => KodePromo(data_p: widget.data_p,)),  ); 
                }else if(index==3){
                    //voucher
                   Navigator.push( context,MaterialPageRoute(builder: (context) => KodeVoucher(data_p: widget.data_p,)),  ); 
                }else if(index==4){
                     //bagikan aplikasi
                   ...
                   Navigator.push( context,MaterialPageRoute(builder: (context) => PilihBahasa()),  ); 
                     ...
                     //bantuan
                    Navigator.push( context,MaterialPageRoute(builder: (context) => WebViewExample(title:'Bantuan', data_url: 'https://pribumisoftware.com/bantuan',)),  );
                }else if(index==8){
                     //kebijakan privasi
                     Navigator.push( context,MaterialPageRoute(builder: (context) => WebViewExample(title:'Kebijakan Privasi', data_url: 'https://pribumisoftware.com/kebijakanprivasi',)),  );
                }else if(index==9){
                      //ketentuan layanan
                     Navigator.push( context,MaterialPageRoute(builder: (context) => WebViewExample(title:'Ketentuan Layanan', data_url: 'https://pribumisoftware.com/ketentuanlayanan',)),  );
                }else if(index==10){
