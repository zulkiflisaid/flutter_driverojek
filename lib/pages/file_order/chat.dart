...
class Chat extends StatelessWidget {
  ...
  Chat({Key key,  @required this.dataP, @required this.peerId, @required this.peerAvatar}) : super(key: key);
...
class ChatScreen extends StatefulWidget {
  ...
  final String peerAvatar;
  final Map<String, dynamic> dataP; 
  ChatScreen({Key key, @required this.dataP, @required this.peerId, @required this.peerAvatar}) : super(key: key);

  @override
  State createState() => new ChatScreenState(dataP:dataP, peerId: peerId, peerAvatar: peerAvatar);
}

class ChatScreenState extends State<ChatScreen> {
  ChatScreenState({Key key, @required this.dataP, @required this.peerId, @required this.peerAvatar});
  ...
  readLocal() async {
   ...
   // id = prefs.getString('token_id') ?? '';
    ...
    Firestore.instance.collection('flutter_driver').document(id).updateData({'chattingWith': peerId});
              ...
              children: <Widget>[
                ...
                document['type'] == 0
                    ? Container(
                        ...
                        padding: EdgeInsets.fromLTRB(15.0, 10.0, 15.0, 10.0),
                        width: 200.0,
                        decoration: BoxDecoration(color: Color(0xfff5a623), borderRadius: BorderRadius.circular(8.0)),
  ...
  Future<bool> onBackPress() {
    if (isShowSticker) {
      setState(() {
       ...
       Firestore.instance.collection('flutter_driver').document(id).updateData({'chattingWith': null});
      ...
      child: Row(
        children: <Widget>[
          ...
          Flexible(
            child: Container(
              child: TextField(
                style: TextStyle(color: Color(0xfff5a623), fontSize: 15.0),
